...
function init() {
  ...
  videoPlayer.addEventListener("ended", handleEnded); //비디오가 완전히 로드 되고 나서 전체 시간을 가져옴.
}
...
module.exports = __webpack_require__(/*! /mnt/c/users/user/desktop/projects/dongtube/assets/js/main.js */"./assets/js/main.js");
